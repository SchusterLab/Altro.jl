...
# evaluations
function cost(obj::ALObjective, X::AbstractVector, U::AbstractVector, k::Int)
    # compute value for cost functions
    cost_ = cost(obj.obj, X, U, k)
